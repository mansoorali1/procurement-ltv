...
st.set_page_config(
    page_title="Procurement Lead Time Variance",
    page_icon="📦",
    layout="wide",
...
# ── Header ───────────────────────────────────────────────────────────────────
st.title("📦 Procurement Lead Time Variance — ML System")
st.caption(
    "Olist E-Commerce | XGBoost Regression | "
    "Test MAE: 4.58 days | Directional Accuracy: 91.67%"
)
st.divider()
